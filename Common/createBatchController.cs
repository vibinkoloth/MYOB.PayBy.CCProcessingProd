...
// Type: MYOB.PayBy.CCProcessing.Common.createBatchController
...
{
  public class createBatchController : ApiOperationBase<PayByHttpRequest, PaybyHttpResponse>
  {
    public createBatchController(PayByHttpRequest apiRequest)
      : base(apiRequest)
    {
    }
