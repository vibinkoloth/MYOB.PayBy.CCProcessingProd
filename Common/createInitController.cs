...
// Type: MYOB.PayBy.CCProcessing.Common.createInitController
...
{
  public class createInitController : ApiOperationBase<PayByHttpRequest, PaybyHttpResponse>
  {
    public createInitController(PayByHttpRequest apiRequest)
      : base(apiRequest)
    {
    }
