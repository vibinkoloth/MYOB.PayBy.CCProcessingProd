<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="PB501000.aspx.cs" 
    Inherits="Page_PB501000" Title="Untitled Page" %>

<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Filter" TypeName="MYOB.PayBy.CCProcessing.Common.PBDirectEntryProcessing" 
     ...
     <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100"
        ...
        <Template>
            ...
            <pxa:PXCurrencyRate DataField="CuryID"
                ...
                RateTypeView="_DDResponseFilter_CurrencyInfo_" DataMember="_Currency_"></pxa:PXCurrencyRate>
        </Template>
    </px:PXFormView>
</asp:Content>
