...
namespace MYOB.PayBy.CCProcessing.PAYBY.PaybyGatewayExt
{
    public static class ProfileServer
    {
        ...
        public static PaymentCompleteResponse GetTransaction(string transactionId, bool removeAfterGet = false)
        {
        ...
        public static PaymentCompleteResponse GetCustomerTransaction(string customerId)
        {
            return ProfileServer.customerTransactions[customerId.SessionIdSufix()]?.paymentCompleteResponse;
        }

        public static IEnumerable<CreditCardData> GetAllPaymentProfiles(string customerProfileId)
        {
        ...
        private static void syncPaybyRequestsForCustomer(string customerProfileId)
        {
